...
Version  : 22.0.1
Release  : 78
URL      : https://files.pythonhosted.org/packages/84/eb/ff6010c207cab902281a6db0ae83b771bf7af5255db088f4d009b1a1fa3d/pyzmq-22.0.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/84/eb/ff6010c207cab902281a6db0ae83b771bf7af5255db088f4d009b1a1fa3d/pyzmq-22.0.1.tar.gz
...
%prep
%setup -q -n pyzmq-22.0.1
cd %{_builddir}/pyzmq-22.0.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1611930717
...
cp %{_builddir}/pyzmq-22.0.1/COPYING.BSD %{buildroot}/usr/share/package-licenses/pyzmq/7a2caf1ffc9ec4ace81dc6d16dd1bfdf800036b8
cp %{_builddir}/pyzmq-22.0.1/COPYING.LESSER %{buildroot}/usr/share/package-licenses/pyzmq/712937582a8adeb3928fed8f08ef6a6dbcf68667
cp %{_builddir}/pyzmq-22.0.1/bundled/zeromq/COPYING %{buildroot}/usr/share/package-licenses/pyzmq/99b1a5c7351fd39a26db3b560ce91eec4a3aca3d
