...
Source0  : https://files.pythonhosted.org/packages/af/9f/5b4942b3b028fb38cd66514472649025644d78ca0b29f7b79e9ff2acc048/pyzmq-21.0.2.tar.gz
...
%prep
%setup -q -n pyzmq-21.0.2
cd %{_builddir}/pyzmq-21.0.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1611675975
...
cp %{_builddir}/pyzmq-21.0.2/COPYING.BSD %{buildroot}/usr/share/package-licenses/pyzmq/7a2caf1ffc9ec4ace81dc6d16dd1bfdf800036b8
cp %{_builddir}/pyzmq-21.0.2/COPYING.LESSER %{buildroot}/usr/share/package-licenses/pyzmq/712937582a8adeb3928fed8f08ef6a6dbcf68667
cp %{_builddir}/pyzmq-21.0.2/bundled/zeromq/COPYING %{buildroot}/usr/share/package-licenses/pyzmq/99b1a5c7351fd39a26db3b560ce91eec4a3aca3d
