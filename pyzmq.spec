...
Source0  : https://files.pythonhosted.org/packages/d6/67/98d0d6ac5c784190a0f9728410902471552cffc78cef37830cd86b9cd70d/pyzmq-22.2.1.tar.gz
...
%prep
%setup -q -n pyzmq-22.2.1
cd %{_builddir}/pyzmq-22.2.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1628178724
...
cp %{_builddir}/pyzmq-22.2.1/COPYING.BSD %{buildroot}/usr/share/package-licenses/pyzmq/7a2caf1ffc9ec4ace81dc6d16dd1bfdf800036b8
cp %{_builddir}/pyzmq-22.2.1/COPYING.LESSER %{buildroot}/usr/share/package-licenses/pyzmq/712937582a8adeb3928fed8f08ef6a6dbcf68667
cp %{_builddir}/pyzmq-22.2.1/bundled/zeromq/COPYING %{buildroot}/usr/share/package-licenses/pyzmq/99b1a5c7351fd39a26db3b560ce91eec4a3aca3d
cp %{_builddir}/pyzmq-22.2.1/bundled/zeromq/external/wepoll/license.txt %{buildroot}/usr/share/package-licenses/pyzmq/0cf031c01628cf0ee33ed398038238a76ebbd1b7
