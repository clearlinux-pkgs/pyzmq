...
Source0  : https://files.pythonhosted.org/packages/c0/f6/a5d9550a7938bdd6af54186b784dd20d52e8b2357f632345243e585c58b1/pyzmq-22.0.0.tar.gz
...
%prep
%setup -q -n pyzmq-22.0.0
cd %{_builddir}/pyzmq-22.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1611848771
...
cp %{_builddir}/pyzmq-22.0.0/COPYING.BSD %{buildroot}/usr/share/package-licenses/pyzmq/7a2caf1ffc9ec4ace81dc6d16dd1bfdf800036b8
cp %{_builddir}/pyzmq-22.0.0/COPYING.LESSER %{buildroot}/usr/share/package-licenses/pyzmq/712937582a8adeb3928fed8f08ef6a6dbcf68667
cp %{_builddir}/pyzmq-22.0.0/bundled/zeromq/COPYING %{buildroot}/usr/share/package-licenses/pyzmq/99b1a5c7351fd39a26db3b560ce91eec4a3aca3d
