...
Source0  : https://files.pythonhosted.org/packages/4c/c5/22744ce59129b11195337d86b0025e9ba9609dea5cf24f45f0017f7237d0/pyzmq-21.0.0.tar.gz
...
%prep
%setup -q -n pyzmq-21.0.0
cd %{_builddir}/pyzmq-21.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610639414
...
cp %{_builddir}/pyzmq-21.0.0/COPYING.BSD %{buildroot}/usr/share/package-licenses/pyzmq/7a2caf1ffc9ec4ace81dc6d16dd1bfdf800036b8
cp %{_builddir}/pyzmq-21.0.0/COPYING.LESSER %{buildroot}/usr/share/package-licenses/pyzmq/712937582a8adeb3928fed8f08ef6a6dbcf68667
cp %{_builddir}/pyzmq-21.0.0/bundled/zeromq/COPYING %{buildroot}/usr/share/package-licenses/pyzmq/99b1a5c7351fd39a26db3b560ce91eec4a3aca3d
